...
// Display the location and times
  if(twoAreas === 0){
     document.getElementById("locationtext").innerHTML = busSchedule[today++];
     document.getElementById("timestext").innerHTML = busSchedule[today];
  }else{
     document.getElementById("locationtext").innerHTML = 
       busSubSchedule[busSchedule[today + 4]++];
     document.getElementById("timestext").innerHTML = 
	 	busSubSchedule[busSchedule[today + 4]];
  }
 
// Display the status
  if(ret === 1){
	 document.getElementById("staustext").innerHTML = "Open";
	 tempChange = document.getElementsByClassName("type1");
	 tempChange[0].style.backgroundColor = "green";
  }else if(ret === 2){
	 document.getElementById("staustext").innerHTML = "Opening Soon";
	 tempChange = document.getElementsByClassName("type1");
	 tempChange[0].style.backgroundColor = "yellow";
  }else if(ret === 3){
	 document.getElementById("staustext").innerHTML = "En Route";
	 tempChange = document.getElementsByClassName("type1");
	 tempChange[0].style.backgroundColor = "yellow";
  }else if(ret === 4){
	 document.getElementById("staustext").innerHTML = "Closing Soon";
	 tempChange = document.getElementsByClassName("type1");
	 tempChange[0].style.backgroundColor = "yellow";
  }else{
	 document.getElementById("staustext").innerHTML = "Closed";
	 tempChange = document.getElementsByClassName("type1");
...
//subSchedule array is used for days where the bus visits two sites.
  var subSchedule = [
    ...
    /*03/08*/"SVMS/SVHS","10:30a - 2:45p","10:30","14:45","0",
...
//					5th index: two locations indicator/index
  var mainSchedule = [
    ...
    /*02/29*/"Riverton Parke","8:30a - 2:00p","8:30","14:00","0",
      /*03/01*/"Riverton Parke","8:30a - 2:00p","8:30","14:00","0",
    ...
    /*03/08*/"Central Elem","8:30a - 10:00a","8:30","10:00",35,
    ...
    /*05/31*/"Summer Break","☼","0:0","0:0","0",
  	  /*06/01*/"Walmart","8:00a - 3:00p","8:00","15:00","0",
    /*06/02*/"Walmart","8:00a - 3:00p","8:00","15:00","0",
    /*06/03*/"Walmart","8:00a - 12:00p","8:00","12:00","0",
    /*06/04*/"Summer Break","☼","0:0","0:0","0",
    /*06/05*/"Summer Break","☼","0:0","0:0","0",
    /*06/06*/"Summer Break","☼","0:0","0:0","0",
    /*06/07*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/08*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/09*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/10*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/11*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/12*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/13*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/14*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/15*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/16*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/17*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/18*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/19*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/20*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/21*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/22*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/23*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/24*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/25*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/26*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/27*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/28*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/29*/"Check Schedule","--->>","0:0","0:0","0",
    /*06/30*/"Check Schedule","--->>","0:0","0:0","0",
	  /*07/01*/"Check Schedule","--->>","0:0","0:0","0",
    /*07/02*/"Check Schedule","--->>","0:0","0:0","0",
    /*07/03*/"Check Schedule","--->>","0:0","0:0","0",
    /*07/04*/"Check Schedule","--->>","0:0","0:0","0",
